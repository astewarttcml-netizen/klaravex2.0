...
class LeadSource(str, enum.Enum):
    chat = "chat"
    cold_outreach_reply = "cold_outreach_reply"   # phase4-003: prospect replied with intent=INTERESTED
...
class Lead(Base):
    ...
    # phase6-002 recurring invoicing
    monthly_retainer_amount: Mapped[float | None] = mapped_column(Numeric(10, 2))
    last_invoice_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
