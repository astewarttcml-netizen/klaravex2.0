...
MAX_SAMPLES = 20
JUDGE_MODEL = "anthropic/nvidia_nim/deepseek-ai/deepseek-v4-flash-0731"
...
async def _run() -> dict:
    ...
    async with db_context() as db:
        ...
        client = AsyncAnthropic(api_key="unused", base_url=getattr(settings, "litellm_base_url", "http://host.docker.internal:8090"))
