 ...
 *
 * Embed in WordPress:
 *   wp_enqueue_script('klara-chat', get_template_directory_uri() . '/js/klara-chat-widget.js', [], '2.1', true);
 *
...
(function () {
    ...
    const I18N = {
        en: {
            ...
            welcomeMessage:    'Hi 👋 I\'m Klara, Klaravex\'s AI assistant. I can answer questions, check your options, or get a senior engineer on it. What\'s going on?',
            ...
            trustRibbon:       '<strong>89% of issues</strong> resolved right here — humans for the rest.',
            chipBook:          'Book a free assessment',
            chipPricing:       'See pricing',
            chipProblem:       'I have a problem',
            chipHuman:         'Talk to a human',
    ...
    const KX = {
        ...
        border:'rgba(240,244,255,0.08)', indigo:'#6366F1', indigo2:'#818CF8',
        violet:'#7C3AED', green:'#22c55e',
    };
    // AI assistant display name (user-facing). Internal IDs stay klx-* for backend compat.
    const AI_NAME = 'Klara';
